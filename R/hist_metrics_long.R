#' Dataset: hydrologic metrics calculated from all Bayesian models for 1938-2019
#'
#' Hydrologic metrics calculated using all simulation results from monte carlo
#' Bayesian Structural Time Series process. Metrics summarize 1938-2019 (CSLS
#' lake) or 1936-2001 (Devils Lake).
#'
#' @docType data
#'
#' @usage data(hist_metrics_long)
#'

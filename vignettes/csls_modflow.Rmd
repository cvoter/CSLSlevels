...
```{r levels01, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=fig_height}
...
```{r levels02, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=fig_height}
plot_levels(modflow_irr, point_size = 1, convert_units = "meterTOft",
            legend_pos = c(0.1, 0.9), grid_off = FALSE, text_size = text_size)
```

## MODFLOW No Irrigation
```{r levels03, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=fig_height}
...
```{r magnitude_02, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=5, fig.height=5}
plot_magnitude(modflow_irr, text_size = text_size)
```

## MODFLOW No Irrigation

```{r magnitude_03, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=5, fig.height=5}
...
```{r frequency01, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=fig_height}
plot_frequency(csls_levels, probs = c(10, 50, 90), text_size = text_size)
```

## MODFLOW Irrigation

```{r frequency02, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=fig_height}
plot_frequency(modflow_irr, probs = c(10, 50, 90), text_size = text_size)
```

## MODFLOW No Irrigation

```{r frequency03, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=fig_height}
...
```{r exceedance_level_01, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=2*fig_height}
...
```{r exceedance_level_02, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=2*fig_height}
table_df <- create_table(irr_metrics, metric_name, variable_breaks, 
                         variable_labels, convert_units = "meterTOft",
                         round_precision = 0.1)
...
```{r exceedance_level_03, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=2*fig_height}
table_df <- create_table(no_irr_metrics, metric_name, variable_breaks, 
                         variable_labels, convert_units = "meterTOft",
                         round_precision = 0.1)
...
```{r duration01, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=5}
...
```{r duration02, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=5}
...
```{r duration03, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=5}
...
```{r rate_of_change01, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=7}
plot_rate_change(csls_levels, text_size = text_size)
```

## MODFLOW Irrigation

```{r rate_of_change02, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=7}
plot_rate_change(modflow_irr, text_size = text_size)
```

## MODFLOW No Irrigation

```{r rate_of_change03, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=7}
...
```{r timing01, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
...
```{r timing02, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
plot_df <- irr_metrics %>%
           filter(.data$metric == "exceedance_range") %>%
           mutate(time = str_sub(.data$variable, 1, 1),
                  range = str_sub(.data$variable, 3, -1),
...
```{r timing03, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
...
```{r exceedance_range_03, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=6.5, fig.height=6}
table_df <- create_table(no_irr_metrics, metric_name, variable_breaks, 
                         variable_labels, convert_units = "meterTOft",
                         round_precision = 0.1)

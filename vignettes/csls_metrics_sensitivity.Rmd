...
0.4 ft for the Central Sands Lakes and within 0.5 ft for Devil's Lake. Mean bias
and mean varirance are less than 0.05% at all lakes.
...
within 0.01% for the Central Sands Lakes and within 0.04% for Devil's Lake. Mean
variance is around 25% for Pleasant Lake, but below 15% for all other lakes.
Mean bias is below 25% for all lakes.

**With longer timeseries,** there is little change in bias, accuracy, and
variance. Values appear to plateau at around a 38 year timeseries, though at
Pleasant Lake, mean variance does not plateau until ~50 years and mean accuracy
and mean bias steadily decline as timeseries length increases.
...
**With a timeseries of 38 years,** the mean accuracy

**With longer timeseries,** 

**Decision:** 

**Implications of using 1981-2018 timeseries:** 

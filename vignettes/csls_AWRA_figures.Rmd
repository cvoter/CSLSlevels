...
p2a <- plot_levels(csls_levels, text_size = text_size, npretty_breaks = 3, exceedance = 90)
p2b <- plot_levels(csls_levels, text_size = text_size, npretty_breaks = 3, exceedance = 10)
p2c <- plot_levels(csls_levels, text_size = text_size, npretty_breaks = 3, exceedance = 50)

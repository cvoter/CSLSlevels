...
p3a <- plot_magnitude(csls_levels, text_size = text_size, probs = 90)
p3b <- plot_magnitude(csls_levels, text_size = text_size, probs = 10)
p3c <- plot_magnitude(csls_levels, text_size = text_size, probs = 50)

...
output: 
  rmarkdown::html_vignette:
    toc: true
vignette: >
  %\VignetteIndexEntry{CSLS Lake Level Exceedance}
...
```{r montecarlo01, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.width = 6.5, fig.height = 3.5}
...
```{r lakelevel01, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.width = 6.5, fig.height = 3.5}
year_prob_level1 <- sensitivity_levels_at_probs(csls_levels, 
                                                years = c(1905:2018), 
                                                probs = probs,
                                                types = "forward")
...
```{r lakelevel02, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.width = 6.5, fig.height = 3.5}
year_prob_level2 <- sensitivity_levels_at_probs(csls_levels, 
                                                years = c(1905:2018), 
                                                probs = probs,
                                                types = "backward")
...
x-axis represents the changing start date of the window. Everything ted here
includes exactly 38 years of data (the end date is 38 years after the ted
date on the x-axis).

```{r lakelevel03, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.width = 6.5, fig.height = 3.5}
year_prob_level3 <- sensitivity_levels_at_probs(csls_levels, 
                                                years = c(1905:2018), 
                                                probs = probs,
                                                types = "forward", 
                                                windows = 38)

plot_analysis_window(year_prob_level3, text_size = text_size)
```
...
```{r curves, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.width = 6.5, fig.height = 3.5}
ranked <- sensitivity_probs_of_levels(csls_levels, 
                                      years = c(1960, 1960, 1981, 2018), 
                                      types = c("forward", "backward",
                                                "backward", "forward"))

...
year_prob_level1 <- find_lake_level_sensitivity(csls_levels, 
                                                years = c(1905:2018), 
                                                probs = probs,
                                                types = "forward")
...
year_prob_level2 <- find_lake_level_sensitivity(csls_levels, 
                                                years = c(1905:2018), 
                                                probs = probs,
                                                types = "backward")
...
year_prob_level3 <- find_lake_level_sensitivity(csls_levels, 
                                                years = c(1905:2018), 
                                                probs = probs,
                                                types = "forward", 
                                                windows = 38)
...
ranked <- rank_lake_levels_sensitivity(csls_levels, 

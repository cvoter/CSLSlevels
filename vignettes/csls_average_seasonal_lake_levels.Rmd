...
```{r montecarlo02, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.width = 7.5, fig.height = 4.5}
...
plot_seasonal_curves <- function(ranked_annual, ranked_seasons, lake_name){
  plot_obj <- ggplot() +
              ...
              scale_color_brewer(palette = "PuOr",
                                 breaks = c("summer", "spring", 
                                            "fall", "winter"),
                                 labels = c("Summer", "Spring", 
                                            "Fall", "Winter")) +
...
plot_lake_areas <- function(lake, ranked_levels) {
  ...
  plot_all  <- plot_grid(legend, plot_maps, ncol = 1, rel_heights = c(0.4, 2))
...
## Pleasant Lake
```{r psnt, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.width = 6.5, fig.height = 4}
lake      <- "Pleasant"
lake_name <- sprintf("%s Lake", lake)
plot_seasonal_curves(ranked_annual, ranked_seasons, lake_name)
```
```{r psnt02, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.width = 7.5, fig.height = 5}
plot_lake_areas(lake, ranked_levels)
```

## Long Lake

```{r long, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.width = 7.5, fig.height = 4.5}
lake      <- "Long"
lake_name <- sprintf("%s Lake", lake)
plot_seasonal_curves(ranked_annual, ranked_seasons, lake_name)
plot_lake_areas(lake, ranked_levels)
...
```{r pfl, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.width = 7.5, fig.height = 4.5}
lake      <- "Plainfield"
lake_name <- sprintf("%s Lake", lake)
plot_seasonal_curves(ranked_annual, ranked_seasons, lake_name)
plot_lake_areas(lake, ranked_levels)

...
```{r estimate, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.width = 7, fig.height = 3.5}
ggplot() +
  geom_line(data = csls_levels,
            aes(x = date, y = level_pred, color = "estimated")) +
  geom_point(data = csls_levels,
             aes(x = date, y = level_obs, color = "observation")) +
  facet_wrap(~lake, scales = "free_y") +
  labs(x = "",
       y = "Estimated Lake Level (mamsl)",
       color = "") +

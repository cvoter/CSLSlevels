...
```{r levels01, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=fig_height, fig.cap="**Figure 2.** Estimated lake levels for each lake (lines) with observations (points) from 1905-2018."}
...
```{r levels02, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=fig_height, fig.cap="**Figure 3.** Estimated lake levels for each lake (lines) with observations (points) from 1981-2018."}
...
```{r frequency, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=fig_height, fig.cap="**Figure 5.** Distribution of lake elevations (ft) with 10%, 50%, and 90% exceedance probabilities noted. All x-axes cover the same range so differences in lake elevation are comparable across plots."}
plot_frequency(csls_levels, probs = c(10, 50, 90), text_size = text_size)
plot_frequency(csls_levels, probs = NULL, text_size = text_size)
```
...
```{r duration02, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=fig_height, fig.cap="**Figure 6.** Distribution of durations above the 10% exceedance probability level and below the 90% exceedance probability level for all lakes, using the complete 1905-2018 timeseries, with the median duration noted."}
plot_duration(csls_levels_all, 
              probs = 90, 
              show_median = TRUE, 
              bin_size = 2, 
...
```{r rate_of_change, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=7, fig.cap="**Figure 7.** Distribution of rates of change for lake levels over 1 month, 3 months, and 12 months with median fall rate and median rise rate noted with vertical lines."}
plot_rate_change(csls_levels, text_size = text_size)
```

```{r rate_of_change02, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=fig_width, fig.height=fig_height, fig.cap="**Figure 7.** Distribution of rates of change for lake levels over 1 month, 3 months, and 12 months with median fall rate and median rise rate noted with vertical lines."}
plot_rate_change(csls_levels, lag_months = 3, text_size = text_size)
plot_rate_change(csls_levels, lag_months = 3, text_size = text_size, show_median = FALSE)
```
